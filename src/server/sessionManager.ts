...
const WATERMARKS = [
  ...
  "> 𝙁𝙀𝙀𝙇 𝙔𝙊𝙐𝙍 𝘿𝘼𝘿𝘿𝙔 𝙔𝙐𝙑𝙍𝘼𝙅 😝",
  "> 𝙁𝙀𝙀𝙇 𝙔𝙊𝙐𝙍 𝘿𝘼𝘿𝘿𝙔 𝙊𝙎𝘼𝙈𝘼 😈",
  "> 𝙁𝙀𝙀𝙇 𝙔𝙊𝙐𝙍 𝘿𝘼𝘿𝘿𝙔 𝙀𝙍𝙄𝘾 😋",
  "> 𝙁𝙀𝙀𝙇 𝙔𝙊𝙐𝙍 𝙈𝙅 𝘿𝘼𝘿𝘿𝙔 😘",
  "> 𝘼𝙍𝙎𝙃𝙄 𝙆𝙄 𝘾𝙃𝙐𝙏 𝙆𝘼 𝙋𝙄𝙔𝘼𝙎𝘼 𝙀𝙍𝙄𝘾 𝙃𝙐𝙉 🥴",
  "> 𝙔𝘼𝙈𝙄𝙆𝙊 𝙆𝙄 𝙈𝘼𝘼 𝘾𝙃𝙊𝘿 𝘿𝙐𝙉 𝙔𝙐𝙑𝙍𝘼𝙅 𝙃𝙐𝙉 🥵",
  "> 𝙆𝙃𝙐𝙆𝙐 𝙍𝘼𝙉𝘿𝙔 𝙆𝙊 𝘾𝙃𝙊𝘿 𝘿𝙐𝙉 𝙊𝙎𝘼𝙈𝘼 𝙃𝙐𝙉 🤤",
  "> 𝙈𝘼𝙃𝙄 𝙆𝙄 𝘾𝙃𝙐𝙏 𝙆𝙃𝙊𝙇𝙉𝙀 𝙒𝘼𝙇𝘼 𝘿𝘼𝘿𝘿𝙔 𝙈𝙅 𝙃𝙐𝙉 {(ᶅ͒)} Ɑ͞ ͞ ͞ ͞ ͞ ﻝﮞ"
];
